...
public interface Lecturer extends Person {
    ...
    /* ***************************************************
     * Property http://www.cs.le.ac.uk/rdf#teach
     */
     
    /**
     * Gets all property values for the teach property.<p>
     * 
     * @returns a collection of values for the teach property.
     */
    Collection<? extends Module> getTeach();

    /**
     * Checks if the class has a teach property value.<p>
     * 
     * @return true if there is a teach property value.
     */
    boolean hasTeach();

    /**
     * Adds a teach property value.<p>
     * 
     * @param newTeach the teach property value to be added
     */
    void addTeach(Module newTeach);

    /**
     * Removes a teach property value.<p>
     * 
     * @param oldTeach the teach property value to be removed.
     */
    void removeTeach(Module oldTeach);
