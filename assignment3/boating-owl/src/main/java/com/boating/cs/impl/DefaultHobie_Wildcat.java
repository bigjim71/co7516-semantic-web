 ...
 * Source Class: DefaultHobie_Wildcat <br>
 * @version generated on Mon Apr 16 16:18:00 CEST 2018 by fh231
 */
public class DefaultHobie_Wildcat extends WrappedIndividualImpl implements Hobie_Wildcat {

    public DefaultHobie_Wildcat(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Boolean> getHasSails() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASSAILS, Boolean.class);
    }

    public boolean hasHasSails() {
		return !getHasSails().isEmpty();
    }

    public void addHasSails(Boolean newHasSails) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASSAILS, newHasSails);
    }

    public void removeHasSails(Boolean oldHasSails) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASSAILS, oldHasSails);
    }
