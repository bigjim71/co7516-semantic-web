 ...
 * Source Class: CabinCruiser <br>
 * @version generated on Mon Apr 16 16:18:00 CEST 2018 by fh231
 */

public interface CabinCruiser extends MotorBoat {
    ...
    /* ***************************************************
     * Property http://www.co7516coursework1.com/jl571/OntologyJl571.rdf#engine
     */
     
    /**
     * Gets all property values for the engine property.<p>
     * 
     * @returns a collection of values for the engine property.
     */
    Collection<? extends Engine> getEngine();

    /**
     * Checks if the class has a engine property value.<p>
     * 
     * @return true if there is a engine property value.
     */
    boolean hasEngine();

    /**
     * Adds a engine property value.<p>
     * 
     * @param newEngine the engine property value to be added
     */
    void addEngine(Engine newEngine);

    /**
     * Removes a engine property value.<p>
     * 
     * @param oldEngine the engine property value to be removed.
     */
    void removeEngine(Engine oldEngine);
    ...
    /* ***************************************************
     * Property http://www.co7516coursework1.com/jl571/OntologyJl571.rdf#hasEngine
     */
     ...
     */
    Collection<? extends Boolean> getHasEngine();
     ...
     */
    void addHasEngine(Boolean newHasEngine);
     ...
     */
    void removeHasEngine(Boolean oldHasEngine);
